...
const app = {
  ...
  initHome: function(){
    ...
    thisApp.containerOfHome = document.querySelector(select.containerOf.home);
    
    // if you find thisApp.containerOfHome
    if(thisApp.containerOfHome){
      // create new instance
      new home(this.containerOfHome);
    }
  },
